 ...
 **************************************/
	...
	try
	{
		...
		gds__log_to_file(Firebird::Config::getGfixLogOutputFileName(), "Database: %s\n\tValidation started", fileName.c_str());
 ...
 **************************************/
	...
	catch (const Firebird::Exception&)
	{
		if (!(vdr_flags & VDR_online))
		{
			...
			gds__log_to_file(Firebird::Config::getGfixLogOutputFileName(), msg, relation->rel_id, relation->rel_name.c_str());
		}
#ifdef DEBUG_VAL_VERBOSE
		if (VAL_debug_level)
		{
